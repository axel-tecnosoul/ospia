...
<body class="bg1">
  ...
  <div class="appHeader no-border transparent position-absolute">
    ...
    <div id="appCapsule" class="pt-0">
      ...
      foreach ($grupo_fliar as $persona) {?>
        <div class="listview link-listview search-result animate__animated animate__fadeInRight">
          <div class="wide-block1 pt-2 pb-2" style="text-align: center;">
            ...
            <button type="button" class="btn btn-secondary persona <?=($persona===reset($grupo_fliar))?"titular":""?>" data-id="<?=$persona["Id"]?>"><?=$persona["Nombre"]?></button>
          </div>
        </div><?php
      }?>
      ...
      <div class="modal fade col"  id="DialogImage" data-bs-backdrop="static" role="dialog">
        <div class="modal-dialog"  role="document">
          <div class="modal-content" style="border-radius: 50px"><!-- ;width: 447px; -->
            <div class="modal-body" style="padding: 0;margin-bottom: 0;"><?php
              ...
              <img id="credencial" src="assets/img/credencial_modelo.png" alt="image" class="img-fluid" style="width:100%;"><!-- style="width: 500px;height: 322px;" -->
              <!-- <span class="datos_credencial" id="foto"></span>
              <span class="datos_credencial" id="nombre_apellido"></span>
              <span class="datos_credencial" id="caracter"></span>
              <span class="datos_credencial" id="plan"></span>
