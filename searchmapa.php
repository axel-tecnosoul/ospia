...
<body class="bg1">
          ...
          <div class="row">
            <div class="col-6 mt-1">
              <!-- <button type="button" class="btn btn-primary btn5 btn-sm btn-block">
                ...
                <a href="search-page.php">Ver en listado</a>
              </button> -->
              <!-- <a href="search-page.php" class="btn btn-primary btn5 btn-sm btn-block">
                <ion-icon name="list-circle"></ion-icon>
                Ver en listado
              </a> -->
  ...
  <div id="map" class="mapArea d-none"></div>
