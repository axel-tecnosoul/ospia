...
if($_GET['op'] == "download") {  
	...
	require_once('file:///C|/wamp/www/exportar/Classes/PHPExcel/Shared/JAMA/docs/Archive/Tar.php');  
...
<ul>
 <li><a href='<?php echo $_SERVER['file:///C|/wamp/www/exportar/Classes/PHPExcel/Shared/JAMA/docs/PHP_SELF']."?op=download"; ?>'><?php echo $tarName ?></a></li>
</ul>
<?php
