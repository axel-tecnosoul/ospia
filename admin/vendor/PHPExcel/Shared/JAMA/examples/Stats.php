...
include_once 'file:///C|/wamp/www/exportar/Classes/PHPExcel/Shared/JAMA/examples/PEAR.php';
...
*
* <pre>
* include_once 'file:///C|/wamp/www/exportar/Classes/PHPExcel/Shared/JAMA/examples/Math/Stats.php';
* $s = new Math_Stats();
* $s->setData($data1);
* // or
