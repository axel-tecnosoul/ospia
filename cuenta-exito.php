...
<body class="bg1">
    ...
    <div class="appHeader no-border transparent position-absolute">
        <div class="left animate__animated animate__fadeInRight">
            <a href="page-login.php" class="headerButton goBack">
    ...
    <div id="appCapsule">
        ...
        <div class="login-form animate__animated animate__fadeInRight">
            <div class="section">
                ...
                <h4>Seras Redirigido al Login en 30 segundos</h4>
            </div>
        ...
        <div class="login-form animate__animated animate__fadeInRight">
            <div class="section">
                <h1>Su cuenta ya existe</h1>
                <h4>Seras Redirigido a la página de registro en 30 segundos</h4>
            </div>
